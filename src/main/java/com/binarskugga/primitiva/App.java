...
public class App {
	...
	public static void main(String[] args) {
		...
		System.out.println(ClassTools.of(Boolean[][].class).getCollectionTypeFromArray().get());

		Double[][][] test = Primitiva.Convert.primitive(Integer[][][].class).convertTo(new Integer[][][]{
				new Integer[][]{
						new Integer[]{ 56, 0 },
						new Integer[]{ 43, -50 }
				},
